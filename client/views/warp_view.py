...
class WarpView(arcade.View):
    ...
    def __init__(self, game_manager, target_planet_index, duration):
        ...
        self._warp_sound_started = False
    ...
    def _play_sfx(self, sound_key, intensity=1.0):
        ...
        fallback = {
            "jump_execute": ":resources:sounds/jump1.wav",
            "planet_docking": ":resources:sounds/upgrade5.wav",
        }.get(str(sound_key), ":resources:sounds/jump1.wav")
        try:
    ...
    def _complete_arrival(self, travel_event_line=""):
        ...
        self._play_sfx("planet_docking", 0.95)
    ...
    def on_update(self, delta_time):
        if not self._warp_sound_started:
            self._play_sfx("jump_execute", 1.0)
            self._warp_sound_started = True
