...
class Spaceship:
    ...
    def calculate_value(self):
        ...
        from constants import (
            UPGRADE_PRICE_CARGO,
            UPGRADE_PRICE_SHIELD,
            UPGRADE_PRICE_DEFENDER,
        )
...
class Player:
    def __init__(self, name, spaceship, credits=200):
        ...
        self.owned_planets = {}  # planet_id: last_payout_time
        self.barred_planets = {}  # planet_id: expiry_time
        self.attacked_planets = {}  # planet_id: last_attack_timestamp
